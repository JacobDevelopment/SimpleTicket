...
INSERT OR IGNORE INTO CONFIGURATION(ID, MAJOR, MINOR, PATCH, SUFFIX, CURRENT_SCHEMA_VERSION)
VALUES (1, 0, 1, 1, 'beta', 'v0.1.2-beta');
...
(
    ...
    DONT_SHOW_TICKET_CONFIRMATION BOOLEAN             NOT NULL DEFAULT FALSE
);

INSERT OR IGNORE INTO SETTINGS(ID, ARCHIVE_TICKETS, AUTO_ARCHIVE_TICKETS, AUTO_DELETE_TICKETS, AUTO_DELETE_DATE,
                               AUTO_ARCHIVE_DATE, ARCHIVE_DIRECTORY, DONT_SHOW_CONFIRMATION, DONT_SHOW_TICKET_CONFIRMATION)
